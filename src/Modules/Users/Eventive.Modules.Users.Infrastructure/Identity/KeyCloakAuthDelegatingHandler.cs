...
//wire upin DI container
//we use DelegatingHandler for outgoing req
//for incoing req we use middleware
internal sealed class KeyCloakAuthDelegatingHandler(IOptions<KeyCloakOptions> options) : DelegatingHandler
{
    private readonly KeyCloakOptions _options = options.Value;

    //override the SendAsync method and add custom behaviours
