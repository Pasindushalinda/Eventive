...
namespace Eventive.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241202074303_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventive.Common.Infrastructure.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Eventive.Common.Infrastructure.Inbox.InboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Eventive.Common.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Eventive.Modules.Users.Domain.Users.Permission", b =>
                {
            ...
            modelBuilder.Entity("Eventive.Modules.Users.Domain.Users.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Eventive.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("Eventive.Modules.Users.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Eventive.Modules.Users.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("Eventive.Modules.Users.Domain.Users.User", null)
                        .WithMany()
