...
namespace Eventive.Modules.Attendance.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241202073932_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventive.Modules.Attendance.Domain.Attendees.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Eventive.Modules.Attendance.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Eventive.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Eventive.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Eventive.Modules.Attendance.Domain.Attendees.Attendee", null)
                        .WithMany()
                    ...
                    b.HasOne("Eventive.Modules.Attendance.Domain.Events.Event", null)
                        .WithMany()
